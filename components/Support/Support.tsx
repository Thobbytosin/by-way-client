...
const Support = (props: Props) => {
  ...
  if (contentDomainLoading.faqsLoading) {
      ...
      <div className={styles.pageMinSize}>
        ...
        {serverError ? (
          ...
          <>
            ...
            >
              <div className=" lg:w-full sm:w-[75%]">
                ...
                <p className=" leading-[1.6rem] sm:leading-[1.9rem] text-[14px] sm:text-left text-center">
                  Explore 50+ integrations that make your day-to-day workflow
                  more efficient and familiar. Our extensive developer tools
                  might also strike your fancy website.
                </p>
            ...
            <div className={`${styles.paddingY} ${styles.paddingX} w-full`}>
              <p
                className={`font-medium mb-6 text-base text-center text-primary`}
              >
              ...
              <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-10 mt-16">
                {contentDomainData.faqs?.map((faq: any, index: number) => (
                  <div
                    key={index}
                    className=" w-full border-b border-gray-500 pb-8"
                  >
                    <div
